...
function renderSettings(): ReturnType<typeof renderWithClient> {
  return renderWithClient(<ModelSelectionSection />);
}

describe("ModelSelectionSection fast model", () => {
  afterEach(() => vi.restoreAllMocks());

  it("selects a catalog model and saves its thinking and effort parameters", async () => {
