...
import type { AgentRunState, SessionDetail } from "../lib/contracts";
...
export function StatusBar({ session, state, tokens, costLabel }: { session: SessionDetail; state?: AgentRunState | string; tokens?: number; costLabel?: string }): ReactElement {
  const { t } = useI18n();
