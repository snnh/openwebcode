...
export class PermissionCoordinator {
  ...
  needsApproval(mode: PermissionMode, rules: PermissionRule[], tool: string, input: Record<string, unknown>): boolean {
    ...
    if (["read_file", "glob", "grep", "read_artifact", "load_skill", "spawn_task", "spawn_swarm", "todo_write", "remember", "task_output", "repo_map", "code_search", "git_status", "git_diff"].includes(tool)) return false;
